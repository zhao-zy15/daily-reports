#!/usr/bin/env python3
"""Generate arXiv daily report for 2026-03-26 by concatenating part files."""
import os, glob

BASE = os.path.dirname(os.path.abspath(__file__))
PARTS_DIR = os.path.join(BASE, 'report_parts', '2026-03-26')
OUT = os.path.join(BASE, 'arxiv-papers', 'report-2026-03-26.html')
